...
#if you get an error that there is a mismatch between chromedriver and chrome, on Mac you can update chromedriver by doing "brew cask upgrade chromedriver" https://stackoverflow.com/questions/55201226/session-not-created-this-version-of-chromedriver-only-supports-chrome-version-7
